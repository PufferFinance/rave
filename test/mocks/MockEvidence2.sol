...
abstract contract MockEvidence {
    function report() public pure virtual returns (JSONBuilder.Values memory);
...
contract ValidBLSEvidence is MockEvidence {
    function report() public pure override returns (JSONBuilder.Values memory) {
        return JSONBuilder.Values(
